        ...
        {allPresets.map((preset) => {
          ...
          return (
            <button
              ...
              className={`p-2 border rounded-lg hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-400 text-center truncate">{preset.name}</p>
            </button>
          )
        })}
      </div>
